...
#### Scenario: Orchestrator and narrative share budget
...
#### Scenario: Call proceeds when headroom exists
...
#### Scenario: Call waits when window is full
...
#### Scenario: Usage from OpenAI response
...
#### Scenario: Remaining tokens header
...
#### Scenario: No NARRATIVE_LLM_CONCURRENCY throttle
